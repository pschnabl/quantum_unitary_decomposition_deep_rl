...
class HEREnvRandomTargets(gym.Env):
    '''
    ...
    creating a corresponding efficient quantum circuit. The target unitary is randomly generated
    ...
    def __init__(self, gates, num_qubits, tolerance=1e-3, max_steps=130):
        ...
        # initialize a random target unitary
        self.target_unitary = random_unitary(2**num_qubits, seed=self.np_random).to_matrix()
    ...
    def step(self, action):
        ...
        '''
        # get the gate and the qubits corresponding to integer defining the action
